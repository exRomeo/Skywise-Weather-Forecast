package com.example.skywise.domain.settings
...
object SkywiseSettings {
    ...
    fun initialize(sharedPreferences: SharedPreferences) {
        SkywiseSettings.sharedPreferences = sharedPreferences
        readPrefs()
    }
    ...
    fun setAlertType(alertType: String) {
        SkywiseSettings.alertType = alertType
