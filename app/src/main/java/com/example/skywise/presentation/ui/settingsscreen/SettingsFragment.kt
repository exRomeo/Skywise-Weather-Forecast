...
import com.example.skywise.domain.settings.SkywiseSettings.ARABIC
import com.example.skywise.domain.settings.SkywiseSettings.ENGLISH
import com.example.skywise.domain.settings.SkywiseSettings.GPS
import com.example.skywise.domain.settings.SkywiseSettings.IMPERIAL
import com.example.skywise.domain.settings.SkywiseSettings.MAP
import com.example.skywise.domain.settings.SkywiseSettings.METRIC
import com.example.skywise.domain.settings.SkywiseSettings.NOTIFICATION
import com.example.skywise.domain.settings.SkywiseSettings.STANDARD
import com.example.skywise.domain.utils.LocationUtils
import com.example.skywise.domain.utils.NotificationUtils
import com.example.skywise.domain.utils.PermissionsUtil
